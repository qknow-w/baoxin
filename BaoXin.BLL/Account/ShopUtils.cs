...
namespace BaoXin.BLL
{
    public partial class ShopUtils
    {
        ...
        {
            return SecureHelper.AESEncrypt(encryptStr, "userInfo");
        }
        ...
        {
            return SecureHelper.AESDecrypt(decryptStr, "userInfo");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static Guid GetUidCookie()
        {
            return TypeHelper.StringToGuid(GetBSPCookie("uid"));
        }
