...
//                }
        ...
        callback: function (editor, $w, url, state) {
            ...
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='" + editor.options.imagePath + url + "' class='edui-image-pic' width='100' height='100'/>"),
    ...
    var Upload = {
        ...
        render: function (sel, t) {
            ...
            var verinfo = (browser + "").replace(/[^0-9.]/ig, "");
            var uploadTpl = ""; 
            if (verinfo < 9&&verinfo!="") {
                  uploadTpl = '<div class="edui-image-upload%%">' +
                   
                    '<form class="edui-image-form" method="post" enctype="multipart/form-data" target="up">' +
                    '<input style="width:100"  class="edui-image-file" type="file" hidefocus name="upfile" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
                    '</form>' +
                    '</div>';
            } else {
                uploadTpl = '<div class="edui-image-upload%%">' +
            ...
            $(sel, me.dialog).append($(uploadTpl.replace(/%%/g, t)));
        ...
        submit: function (callback) {
            ...
            if (verinfo < 9) {
                str = '<input class="edui-image-file" type="file" hidefocus="" name="upfile" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">';
               

            } else {
                str='<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="upfile" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">';
